...
class SolarSystem:
    ...
    def __init__(self, mass_sun,
        ...
        self.sun = Body(r=[0, 0], v=[0, 0], mass=mass_sun)
        self.planets = [self.init_body_in_orbit_at_x_and_y(mass_sun * elliptical_orbit_factor, r_body, mass_body)
                        for r_body, mass_body in planets_r_and_mass]

    @classmethod
    def init_body_in_orbit_at_radius_and_angle(cls, mass_sun, radius_body, angle_body, mass_body):
        """
    ...
    @classmethod
    def init_body_in_orbit_at_x_and_y(cls, mass_sun, r, mass_body):
        """
        ...
        """
        return Body.create_body_at_xy_in_orbit(r, mass_body, mass_sun)
